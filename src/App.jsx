  ...
  return (
    <Router>
      <div className='flex flex-col min-h-screen'>
        {' '}
        {/* Ensures the layout spans the entire viewport height */}
        {/* Header */}
        <Header />
        {/* Main Content */}
        <main className='flex-grow'>
          <Routes>
            ...
            <Route
              ...
              element={<HireAMiniTruck />}
            />
            <Route
              path='/services/house-shifting'
              element={<HouseShifting />}
            />
            <Route
            ...
            <Route
              ...
              element={<StorageFacility />}
            />
            <Route
              path='/services/vehicle-shifting'
              element={<VehicleShifting />}
            />
          </Routes>
        </main>
        {/* Footer */}
