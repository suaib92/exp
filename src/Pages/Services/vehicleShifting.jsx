          ...
          <div className='flex flex-col md:flex-row'>
            <div className='md:w-7/12 px-4 mb-8 md:mb-0'>
              <h1 className='text-4xl font-bold leading-tight text-gray-900'>
                {selectedState
                  ? `Vehicle Shifting in ${selectedStateObject.label}`
                  : 'Vehicle Shifting'}
              </h1>
        ...
        <div className='container mx-auto flex flex-col md:flex-row items-center md:space-x-8'>
          ...
          <div className='md:w-1/2 md:pl-12 text-center md:text-left'>
            ...
            <p className='text-gray-600 leading-relaxed text-lg'>
              ...
              moving services. We transport your vehicle as part of a larger
              move or on its own.
              <br />
              <br />
              We strive to offer best-in-class vehicle moving service whatever
              the type: sedan, hatchback or SUV, luxury cars, motorbikes and
              other two-wheelers etc. Also, we ensure cost-effective and
              convenient shipping of your vehicle. A dedicated move manager will
              assist you through each step of the process to get your vehicle
              transported with ease. We have relocated 100000+ happy and
              satisfied clients, who stand as the biggest testimony to our
              success.
            </p>
          </div>
        </div>
      ...
      <section>
        <div className='container mx-auto p-6'>
          <h2 className='text-2xl font-semibold mb-6 text-center text-gray-800'>
            {selectedState
              ? `Vehicle shifting prices in ${selectedStateObject.label}`
              : 'Vehicle shifting prices'}
          </h2>
          {!selectedState && (
        ...
        <div className='mb-16'>
          <div className='text-center mb-12'>
            ...
            <p className='text-gray-600 max-w-3xl mx-auto'>
              ...
              customer-friendly policies, we have tried to simplify the vehicle
              shifting process.
            </p>
          </div>
        ...
        <div className='container mx-auto flex flex-col md:flex-row items-center px-4'>
          <div className='md:w-1/2 md:pl-12 mb-8 md:mb-0'>
            ...
            <p className='text-gray-700 text-lg leading-relaxed mb-4'>
              ...
              vehicle(s) is moved safely and on time. We have acquired
              first-hand knowledge of transportation best practices, including
              legal regulations, duties and tolls. Some of the advantages we
              offer are:
              <br />
              ...
              <br />
              Assurance for the safety and security of your vehicle
              <br />
      ...
      <section>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10'>
          <h1 className='text-3xl font-bold text-center mb-8'>
            Frequently asked questions about vehicle shifting
          </h1>
        ...
        <section className='bg-white py-12'>
          <div className='max-w-7xl mx-auto px-6'>
            <h2 className='text-3xl font-bold text-center text-gray-900 mb-12'>
              Locations We Serve vehicle shifting services in{' '}
          ...
          <div className='max-w-7xl mx-auto px-6'>
            <a href='#form' className='block mb-8'>
              <h2 className='text-3xl font-bold text-center text-gray-900'>
                {selectedState
                  ? ` vehicle shifting services In ${selectedStateObject.label}`
