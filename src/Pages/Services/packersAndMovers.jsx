        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">
              How Pikkol Packers & Movers Works?
            </h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              Pikkol has simply redefined the relocation experience with a
              simplistic approach:
            </p>
          </div>
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center px-4">
          <div className="md:w-1/2 md:pl-12 mb-8 md:mb-0">
            <h2 className="text-3xl font-semibold text-gray-800 mb-4">
              Choose Professional Service with Pikkol!
            </h2>
            <p className="text-gray-700 text-lg leading-relaxed mb-4">
              ...
              prized possessions. Pikkol has emerged as the best Packer and
              ...
              <table className="min-w-full border-collapse border border-gray-300 rounded-lg shadow-md">
                <thead>
                  <tr className="bg-gray-100">
                    <th className="border border-gray-300 px-6 py-3 text-left text-sm font-medium text-gray-500 bg-gray-200 animate-pulse"></th>
                    <th className="border border-gray-300 px-6 py-3 text-left text-sm font-medium text-gray-500 bg-gray-200 animate-pulse"></th>
                    <th className="border border-gray-300 px-6 py-3 text-left text-sm font-medium text-gray-500 bg-gray-200 animate-pulse"></th>
                    <th className="border border-gray-300 px-6 py-3 text-left text-sm font-medium text-gray-500 bg-gray-200 animate-pulse"></th>
                    <th className="border border-gray-300 px-6 py-3 text-left text-sm font-medium text-gray-500 bg-gray-200 animate-pulse"></th>
                ...
                <tbody>
                  {Array(5)
                    ...
                    .map((_, index) => (
                      ...
                      >
                        <td className="border border-gray-300 px-6 py-4 bg-gray-200 animate-pulse"></td>
                        <td className="border border-gray-300 px-6 py-4 bg-gray-200 animate-pulse"></td>
                        <td className="border border-gray-300 px-6 py-4 bg-gray-200 animate-pulse"></td>
                        <td className="border border-gray-300 px-6 py-4 bg-gray-200 animate-pulse"></td>
                        <td className="border border-gray-300 px-6 py-4 bg-gray-200 animate-pulse"></td>
